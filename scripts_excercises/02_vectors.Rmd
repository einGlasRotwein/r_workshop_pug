...
1.1) Create some vectors. Create one vector with characters, one with whole numbers, one with decimals and one with logicals. Save them all into different variables.

### Mathematical operations

What's important about vectors is that you can do mathematical operations with them.
...
4.2) Can you think of a way how we can modify and use this as an index to find the first three hot dog contestants?
...
If you hover over the little exclamation mark, it actualy tells you what you should use instead, which is:
