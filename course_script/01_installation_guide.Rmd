...
- 1) Open RStudio and type `41 + 1` into the console (there should be a tab called "console" in RStudio, see Fig 2.8). What happens?
- 2) Is there a Git pane somewhere in your RStudio? (Like in Fig. 2.4)
